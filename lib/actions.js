...
(function(){
     ...
     * 
     */
    ActionEmpty.inherits(BaseAction);
    
    function ActionEmpty(duration) {
        BaseAction.apply(this, [duration]);
    }
    
    ActionEmpty.prototype.setTarget = function(target) {
        this.$super.setTarget.call(this, target);
    };
    
    ActionEmpty.prototype.update = function(time) {
        this.$super.update.call(this, time);
    };
